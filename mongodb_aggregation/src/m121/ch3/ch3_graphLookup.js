//Problem:
//
//Now that you have been introduced to $graphLookup, let's use it to solve an interesting 
//need. You are working for a travel agency and would like to find routes for a client! For 
//this exercise, we'll be using the air_airlines, air_alliances, and air_routes collections 
//in the aggregations database.
//
...
//should be national carriers from Germany, Spain or Canada only. Include both the destination
// and which airline services that location. As a small hint, you should find 158 destinations.
